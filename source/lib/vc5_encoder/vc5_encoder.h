...
#include "vc5_common.h"
    ...
    typedef enum
    {
        ...
        VC5_ENCODER_PIXEL_FORMAT_RGGB_16 = 7,           // RGGB pixels in the top bits of 16bits (left-justified 12 or 14bit)

        VC5_ENCODER_PIXEL_FORMAT_GBRG_16 = 8,           // GBRG pixels in the top bits of 16bits (left-justified 12 or 14bit)

        VC5_ENCODER_PIXEL_FORMAT_BGGR_16 = 9,           // BGGR pixels in the top bits of 16bits (left-justified 12 or 14bit)
